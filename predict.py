...
df = pd.read_csv('D:\ML Projects\diabetes.csv')
...
if submit:
        ...
        if prediction == 0:
            st.write('Congratulation!!',name,', You have no diabetes.')
        else:
            st.write(name,", we are really sorry to say but it seems like you are Diabetic.")
            st.write("Plese, consult to your doctor for the further trearment")
